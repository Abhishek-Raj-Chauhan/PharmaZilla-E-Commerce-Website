    ...
    <div class="poster">
      <div class="fade">
        ...
        <div class="Containers">
          <img src="C:\xampp\htdocs\pharma\resources\text\Css\sale.jpg" style="width:100%;border-radius: 10px;">
        </div>
        <div class="Containers">
          <img src="C:\xampp\htdocs\pharma\resources\text\Css\sale4.jpg" style="width:100%;border-radius: 10px;">
        </div>
        <div class="Containers">
          <img src="C:\xampp\htdocs\pharma\resources\text\Css\sale3.jpg" style="width:100%;border-radius: 10px;">
        </div>
